  ...
  return (
    <section className={sectionClass}>
      ...
      {((character.defenses &&
          ...
          <div className="flex flex-wrap gap-x-3 gap-y-1.5 text-xs text-slate-500 leading-snug pt-2 border-t border-slate-100">
      ...
      <div className="border-t border-slate-100 pt-3">
        <div className="flex flex-wrap gap-2">
          {(['STR', 'DEX', 'CON', 'INT', 'WIS', 'CHA'] as const).map((ability) => (
            <div
              key={ability}
              className="px-2.5 py-1.5 rounded-lg bg-slate-50 border border-slate-100 flex items-center gap-2 justify-between min-w-[4.5rem]"
            >
